...
print('Before inf replace prediction:')
...
kaggle_to_cic = {
    ...
    'URG Flag Count': 'urg_flag_cnt', 'CWA Flag Count': 'cwr_flag_count',
    'ECE Flag Count': 'ece_flag_cnt', 'Down/Up Ratio': 'down_up_ratio',
    'Average Packet Size': 'pkt_size_avg', 'Avg Fwd Segment Size': 'fwd_seg_size_avg',
    'Avg Bwd Segment Size': 'bwd_seg_size_avg', 'Fwd Header Length.1': 'fwd_header_len',
    'Fwd Avg Bytes/Bulk': 'fwd_byts_b_avg', 'Fwd Avg Packets/Bulk': 'fwd_pkts_b_avg',
    'Fwd Avg Bulk Rate': 'fwd_blk_rate_avg', 'Bwd Avg Bytes/Bulk': 'bwd_byts_b_avg',
    'Bwd Avg Packets/Bulk': 'bwd_pkts_b_avg', 'Bwd Avg Bulk Rate': 'bwd_blk_rate_avg',
...
X_live = pd.DataFrame(columns=clf.feature_names_in_)
for col in clf.feature_names_in_:
    mapped_name = kaggle_to_cic.get(col)
    if mapped_name:
...
print('Sum predictions with inf stripped:', sum(preds))
